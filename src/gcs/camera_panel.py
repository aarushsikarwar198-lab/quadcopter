...
class CameraPanel(QWidget):
    def __init__(self, parent=None):
        ...
        # This text embeds "grid_box"/"room" straight from whatever sent
        # the camera frame. QLabel auto-detects rich text by default, so
        # a value that happens to contain "<" would otherwise be parsed
        # as markup instead of displayed as-is. Pin it to plain text.
        self.tag_label.setTextFormat(Qt.TextFormat.PlainText)
