...
class SurvivorItem(QFrame):
    def __init__(self, sv: dict, parent=None):
        ...
        # "grid_box" is external data (from whatever's on the other end
        # of the bridge). QLabel's default auto-detection would treat a
        # value containing "<" as rich text instead of literal text —
        # pin this to plain text so it always renders exactly as sent.
        box_lbl.setTextFormat(Qt.TextFormat.PlainText)
