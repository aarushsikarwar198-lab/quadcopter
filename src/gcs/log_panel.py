...
class LogPanel(QWidget):
    ...
    def log(self, message: str, warn: bool = False) -> None:
        ...
        # `message` is rendered as rich text (append() interprets HTML),
        # but it can contain live data we don't control — a bridge URL
        # with a "&", a JSON parse error echoing back "<" from a
        # malformed frame, etc. Escaping it is what keeps those from
        # being interpreted as markup and mangling or truncating the line.
